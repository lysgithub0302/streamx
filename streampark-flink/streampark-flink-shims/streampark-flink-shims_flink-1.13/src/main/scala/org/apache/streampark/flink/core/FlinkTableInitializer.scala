...
private[flink] class FlinkTableInitializer(args: Array[String], apiType: ApiType) extends FlinkStreamingInitializer(args, apiType) {
  ...
  override def initParameter(): ParameterTool = {
    ...
    parameter.get(KEY_FLINK_SQL()) match {
      case null => parameter
      case param =>
<<<<<<<< HEAD:streampark-flink/streampark-flink-shims/streampark-flink-shims_flink-1.13/src/main/scala/org/apache/streampark/flink/core/FlinkTableInitializer.scala
        //for streampark-console
========
        //for strstreamparkeamx-console
>>>>>>>> 67724c8cc187bb17d29810479113f8b00d42d1d1:streampark-flink/streampark-flink-shims/streampark-flink-shims_flink-1.12/src/main/scala/org/apache/streampark/flink/core/FlinkTableInitializer.scala
